				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showSellerVoteBuyerDone.done"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showSellerVoteBuyerDone.click"/>&nbsp;<a href="showSellerContact.do" class="data2Link"><bean:message key="showSellerVoteBuyerDone.here"/></a>&nbsp;<bean:message key="showSellerVoteBuyerDone.goToContacts"/>.
						</td>
					</tr>
				</table>
			</td>
