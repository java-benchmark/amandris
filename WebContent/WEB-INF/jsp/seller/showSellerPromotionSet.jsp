				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showSellerPromotionSet.text1"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showSellerPromotionSet.click"/>&nbsp;<a href="showSellerPromotion.do" class="data2Link"><bean:message key="showSellerPromotionSet.here"/></a>&nbsp;<bean:message key="showSellerPromotionSet.goToPromotion"/>.
						</td>
					</tr>
				</table>
			</td>
