				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td class="data3Text" align="center" style="color:#DD55AA;">
							<b><bean:message key="showNewSellerActivated.congratulations"/></b>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center" style="text-align:justify;">
							<b><bean:message key="showNewSellerActivated.activated"/></b>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showNewSellerActivated.click"/>&nbsp;<a href="http://www.amandris.com" class="data2Link"><bean:message key="showNewSellerActivated.here"/></a>&nbsp;<bean:message key="showNewSellerActivated.goToIndex"/>.
						</td>
					</tr>
				</table>
			</td>
