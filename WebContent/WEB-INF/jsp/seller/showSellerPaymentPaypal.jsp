				...
				<table width="90%" cellpadding="0" cellspacing="0" boder="0">
					<tr>
						<td align="center" class="data1Text">
							<bean:message key="showSellerPaymentPaypal.text1"/> 
						</td>
					</tr>
					<tr>
							...
							<table width="70%" cellpadding="0" cellspacing="0" boder="0">
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showSellerPaymentPaypal.pack1"/>
									</td>
									<td align="center">
										<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_xclick">
											<input type="hidden" name="business" value="payment@amandris.com">
											<input type="hidden" name="item_name" value="sellerp10c">
											<input type="hidden" name="item_number" value="s<bean:write name="sellerSession" property="id"/>">
								...
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showSellerPaymentPaypal.pack2"/>
									</td>
									<td align="center">
										<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_xclick">
											<input type="hidden" name="business" value="payment@amandris.com">
											<input type="hidden" name="item_name" value="sellerp20c">
											<input type="hidden" name="item_number" value="s<bean:write name="sellerSession" property="id"/>">
