			  			  	...
			  			  	<table width="704" cellpadding="0" cellspacing="0" border="0" valign="top">
			  			  		<tr>
			  			  			<td align="right">
			  			  				<table width="704" cellpadding="0" cellspacing="0" border="0" valign="top">
						  			  		<tr>
		  						  				<logic:notEmpty name="buyerCollection">
							  			  			<td width="550" align="left" class="data1Text">
							  			  				<bean:write name="pager" property="size"/>&nbsp;<bean:message key="showSellerBuyerCollection.found"/>
				  						  			</td>
				  						  			<td>
								  			  			<amandris:pagerTag 	styleClass="pagerTextLink" 
																			name="pager" 
																			action ="showSellerBuyerCollection.do?foo" 
																			maxPages="7" 
						  		...
						  		<tr>
						  			<td>
			  						  	<table width="704" cellpadding="0" cellspacing="0" border="0">
			  						  		<logic:empty name="buyerCollection">
			  						  			<tr>
			  						  				<td class="data1Text" align="center">
			  						  					<bean:message key="showSellerBuyerCollection.notFound"/>
			  						  				</td>
			  						  			</tr>
			  						  		</logic:empty>
			  						  	
				  						  	<logic:notEmpty name="buyerCollection">
				  						  		<logic:iterate name="buyerCollection" id="collection">
											  		<tr>
								  						...
								  						<logic:equal name="collection" property="oddOrEven" value="odd">
									  						<td height="85" width="672" bgcolor="#BC74D8">
									  					</logic:equal>
								  						<logic:notEqual name="collection" property="oddOrEven" value="odd">
									  						<td height="85" width="672" bgcolor="#F1A9FF">
									  					</logic:notEqual>
								  						  	<table width="686" cellpadding="0" cellspacing="0" border="0" >
														  		<tr valign="middle">
														  			<td valign="middle" width="60">
														  				<logic:equal name="collection" property="hasPicture" value="1">
															  				<img src="/media/pictures/smaller/buyer_<bean:write name="collection" property="id"/>_<bean:write name="collection" property="mainPicture"/>_<bean:write name="collection" property="mainPictureCode"/>.jpg"/>
															  			</logic:equal>
														  				...
														  				<table cellpadding="0" cellspacing="0" border="0" align="left">
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
														  							<a href="showBuyer.do?id=<bean:write name="collection" property="id"/>" class="data1Link">
														  				...
														  				<table cellpadding="0" cellspacing="0" border="0" align="center">
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="right">
															  						<b><bean:message key="showSellerBuyerCollection.contactsSent"/>:</b>&nbsp;
														  						</td>
														  						<td nowrap class="data1Text" align="left">
															  						<bean:write name="collection" property="contactsSent"/>
														  						</td>
														  					</tr>
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="right">
															  						<b><bean:message key="showSellerBuyerCollection.contactsAccepted"/>:</b>&nbsp;
														  						</td>
														  						<td nowrap class="data1Text" align="left">
														  					...
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="right">
															  						<b><bean:message key="showSellerBuyerCollection.contactsRejected"/>:</b>&nbsp;
														  						</td>
														  						<td nowrap class="data1Text" align="left">
														  					...
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="right">
															  						<b><bean:message key="showSellerBuyerCollection.contactsCancelled"/>:</b>&nbsp;
														  						</td>
														  						<td nowrap class="data1Text" align="left">
														  			...
														  			<td width="9" align="center"><img src="pictures/verticalSeparator.gif"/></td>
																		<td valign="top" align="left">
														  				<table cellpadding="0" cellspacing="0" border="0" align="left">
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
															  						<b><bean:message key="showSellerBuyerCollection.lastLogin"/>:</b>
															  						<bean:write name="collection" property="lastLoginFrom"/>
														  						</td>
														  					</tr>
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
															  						<b><bean:message key="showSellerBuyerCollection.isOnline"/>:</b>
															  						<logic:equal name="collection" property="isOnLine" value="1">
															  							<bean:message key="common.yes"/>
															  						</logic:equal>
															  						<logic:equal name="collection" property="isOnLine" value="0">
														  					...
														  					<tr>
														  						<td align="center">
														  							<logic:equal name="sellerSession" property="isEscort" value="0">
															  							<a href="showSellerStartInvitation.do?id=<bean:write name="collection" property="id"/>">
																  							<html:img bundle="IMAGE_RESOURCE_KEY" srcKey="sendInvitationEven" border="0"/>
																  						</a>
																  					</logic:equal>
																  					<logic:equal name="sellerSession" property="isEscort" value="1">
															  							<a href="setSellerInvitation.do?id=<bean:write name="collection" property="id"/>&type=2">
																  							<html:img bundle="IMAGE_RESOURCE_KEY" srcKey="sendInvitationEven" border="0"/>
																  						</a>
																  					</logic:equal>
														  						</td>
