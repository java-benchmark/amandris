				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showSellerReplyVoteDone.done"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showSellerReplyVoteDone.done"/>&nbsp;<a href="showSellerVote.do" class="data2Link"><bean:message key="showSellerReplyVoteDone.here"/></a>&nbsp;<bean:message key="showSellerReplyVoteDone.goToVote"/>.
						</td>
					</tr>
				</table>
			</td>
