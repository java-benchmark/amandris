		...
		<tr valign="top">
			...
			<td height="450">	
				<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
					<html:form action="setSellerReplyVote.do">
						<tr>
							<td class="data1Text" align="center">
								<bean:message key="showSellerReplyVote.text1"/>&nbsp;<bean:message key="showSellerReplyVote.click"/>&nbsp;
								<a href="showVoteRules.do" class="data1Link"><bean:message key="showSellerReplyVote.here"/></a>&nbsp;
								<bean:message key="showSellerReplyVote.toSeeRules"/>
							</td>
						</tr>
						...
						<tr>
							<td class="data2Text" align="left">
								<b><bean:message key="showSellerReplyVote.text"/></b>&nbsp;(<bean:message key="showSellerReplyVote.maximun"/>)
							</td>
						</tr>
						<tr><td height="5"></td></tr>
						<tr>
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
									<tr bgcolor="#C185AA" height="30">
										<td width="100%" class="data1Text" align="right">
											<html:submit styleClass="form"><bean:message key="showSellerReplyVote.send"/></html:submit>&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
									</tr>
								</table>
							</td>
