		...
		<tr valign="top">
			...
			<td height="450">	
				<table width="90%" cellpadding="0" cellspacing="0" border="0" align="center">
					<html:form action="setSellerCancelDate.do">
						<tr>
							<td class="data1Text" align="center">
								<bean:message key="showSellerCancelDate.text1"/>
							</td>
						</tr>
						...
						<tr>
							<td class="data1Text" align="left">
								<bean:message key="showSellerCancelDate.text"/>
							</td>
						</tr>
						<tr><td height="5"></td></tr>
						<tr>
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
									<tr bgcolor="#C185AA" height="30">
										<td width="100%" class="data1Text" align="right">
											<html:submit styleClass="form"><bean:message key="showSellerCancelDate.cancel"/></html:submit>&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
									</tr>
								</table>
							</td>
