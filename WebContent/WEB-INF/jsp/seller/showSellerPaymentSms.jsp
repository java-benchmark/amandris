				...
				<table width="93%" cellpadding="0" cellspacing="0" boder="0">
					<tr>
						<td align="center" class="data1Text">
							<bean:message key="showSellerPaymentSms.text1"/> 
						</td>
					</tr>
					<tr>
							...
							<table width="95%" cellpadding="0" cellspacing="0" boder="0">
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showSellerPaymentSms.text2"/>&nbsp;<span style="color:red;"><b>amandris&nbsp;s<bean:write name="sellerSession" property="id"/></b></span>
									</td>
								...
								<tr>
									<td align="center" class="data1Text" valign="top" >
										<bean:message key="showSellerPaymentSms.text3"/>&nbsp;b<bean:write name="sellerSession" property="id"/> 
									</td>
								</tr>	
								<tr><td height="20" colspan="2"></td></tr>
								<tr>
									<td align="center" class="data1Text" valign="top" >
										<bean:message key="showSellerPaymentSms.text4"/>
									</td>
								</tr>								
							</table>
						</td>
