				...
				<table cellpadding="10">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showLoginSeller.title"/>
						</td>
					</tr>
					<tr>
						<td class="data1Text">
							<bean:message key="showLoginSeller.text1"/>
						</td>
					</tr>
					<tr>
						<td align="center">
							<table>
								<html:form action="sellerLogin">
									<tr>
										<td width="50%" class="data1Text" align="right">
											<b><bean:message key="showLoginSeller.login"/></b>
										</td>
									...
									<tr>
										<td width="50%" class="data1Text" align="right">
											<b><bean:message key="showLoginSeller.password"/></b>
										</td>
										<td width="50%" align="left">
									...
									<tr>
										<td colspan="2" align="center">
											<html:submit styleClass="form"><bean:message key="showLoginSeller.accept"/></html:submit>
										</td>
									</tr>
									<tr><td colspan="2" height="50"></td></tr>
									<tr>
										<td colspan="2" align="center">
											<a href="showSellerPasswordReset.do" class="data2Link"><bean:message key="showLoginSeller.forgotPassword"/></a>
										</td>
									</tr>
								</html:form>
							</table>
