				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showSellerPaymentDone.done"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showSellerPaymentDone.click"/>&nbsp;<a href="showSellerStart.do" class="data2Link"><bean:message key="showSellerPaymentDone.here"/></a>&nbsp;<bean:message key="showSellerPaymentDone.goToStart"/>.
						</td>
					</tr>
				</table>
			</td>
