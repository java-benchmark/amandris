				...
				<table width="90%" cellpadding="0" cellspacing="0" boder="0">
					<tr>
						<td align="center" class="data1Text">
							<bean:message key="showSellerPaymentCreditCard.text1"/> 
						</td>
					</tr>
							...
							<table width="70%" cellpadding="0" cellspacing="0" boder="0">
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showSellerPaymentCreditCard.pack1"/>
									</td>
									<td align="center">
										<form action="https://tpv.4b.es/tpvv/teargral.exe" method="post">
											<input type="hidden" name="pszPurchorderNum" value="s10<bean:write name="sellerSession" property="id"/>">
											<input type="hidden" name="store" value="PI00009015">
											<input type="image" src="pictures/buyNow.gif" border="0" name="submit" alt="<bean:message key="showSellerPaymentCreditCard.alt"/>">
										</form>
									</td>
								</tr>
								...
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showSellerPaymentCreditCard.pack2"/>
									</td>
									<td align="center">
										<form action="https://tpv.4b.es/tpvv/teargral.exe" method="post">
											<input type="hidden" name="pszPurchorderNum" value="s20<bean:write name="sellerSession" property="id"/>">
											<input type="hidden" name="store" value="PI00009015">
											<input type="image" src="pictures/buyNow.gif" border="0" name="submit" alt="<bean:message key="showSellerPaymentCreditCard.alt"/>">
										</form>
									</td>
