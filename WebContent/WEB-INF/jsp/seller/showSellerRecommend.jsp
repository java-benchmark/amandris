			  		...
			  		<tr>
			  			<td>
  						  	<table width="704" cellpadding="0" cellspacing="0" border="0">
  						  		<html:form action="setSellerRecommend.do">
	  						  		<tr>
  						  				<td class="data3Text" align="center">
  						  					<b><bean:message key="showSellerRecommend.title"/></b>
  						  				</td>
  						  			</tr>
  						  			<tr><td height="20"></td></tr>
		  						  	<tr>
  						  				<td class="data1Text" align="center">
  						  					<bean:message key="showSellerRecommend.text"/>
  						  				</td>
  						  			</tr>
									<tr>
  						  					...
  						  					<table width="50%" cellpadding="3" cellspacing="0">
  						  						<tr>
  						  							<td nowrap class="data2Text">
  						  								<bean:message key="showSellerRecommend.name"/>
  						  							</td>
  						  							<td>
  						  						...
  						  						<tr>
  						  							<td nowrap class="data2Text">
  						  								<bean:message key="showSellerRecommend.email"/>
  						  							</td>
  						  							<td>
  						  						...
  						  						<tr>
  						  							<td nowrap class="data2Text" valign="top">
  						  								<bean:message key="showSellerRecommend.message"/>
  						  							</td>
  						  							<td>
								  	...
								  	<tr>
								  		<td align="center">
								  			<html:submit styleClass="form"><bean:message key="showSellerRecommend.send"/></html:submit>
								  		</td>
								  	</tr>
								  </html:form>
						  	</table>
