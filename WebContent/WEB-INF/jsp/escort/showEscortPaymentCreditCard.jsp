				...
				<table width="90%" cellpadding="0" cellspacing="0" boder="0">
					<tr>
						<td align="center" class="data1Text">
							<bean:message key="showEscortPaymentCreditCard.text1"/> 
						</td>
					</tr>
							...
							<table width="70%" cellpadding="0" cellspacing="0" boder="0">
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showEscortPaymentCreditCard.pack1"/>
									</td>
									<td align="center">
										<form action="https://tpv.4b.es/tpvv/teargral.exe" method="post">
											<input type="hidden" name="pszPurchorderNum" value="e15<bean:write name="sellerSession" property="id"/>">
								...
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showEscortPaymentCreditCard.pack2"/>
									</td>
									<td align="center">
										<form action="https://tpv.4b.es/tpvv/teargral.exe" method="post">
											<input type="hidden" name="pszPurchorderNum" value="e25<bean:write name="sellerSession" property="id"/>">
											<input type="hidden" name="store" value="PI00009015">
											<input type="image" src="pictures/buyNow.gif" border="0" name="submit" alt="<bean:message key="showEscortPaymentCreditCard.alt"/>">
										</form>
									</td>
								...
								<tr>
									<td align="left" class="data3Text" valign="top">
										<bean:message key="showEscortPaymentCreditCard.pack3"/>
									</td>
									<td align="center">
										<form action="https://tpv.4b.es/tpvv/teargral.exe" method="post">
											<input type="hidden" name="pszPurchorderNum" value="e40<bean:write name="sellerSession" property="id"/>">
											<input type="hidden" name="store" value="PI00009015">
											<input type="image" src="pictures/buyNow.gif" border="0" name="submit" alt="<bean:message key="showEscortPaymentCreditCard.alt"/>">
										</form>
									</td>
