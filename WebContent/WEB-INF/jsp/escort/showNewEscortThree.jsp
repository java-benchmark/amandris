		...
		<tr valign="top">
			...
			<td height="450" class="errorText" align="center">	
				<table width="90%" cellpadding="0" cellspacing="0" boder="0">
					<html:form action="setNewEscort.do">
						...
						<tr>
							<td>
								<table cellpadding="0" cellspacing="0" border="0" align="left">
									<tr height="40">
										<td align="left" >
											<img src="pictures/helpIcon.gif" onMouseover="EnterFixedHelpContent('<bean:message key="showNewSellerThree.promoCode"/>','<bean:message key="showNewSellerThree.promoCode.help"/>', 370, 200); FixedActivate();" onMouseout="FixedDeActivate();">
										</td>
										<td width="10"></td>
										<td class="data1Text" align="right">
											<b><bean:message key="showNewSellerThree.promoCode"/></b>
										</td>
										<td width="5"></td>
										<td class="data1Text" align="left">
											<html:text property="promoCode" size="10" styleClass="form"/>
										</td>
									</tr>
									<tr height="40">
										<td align="left" >
