				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showBuyerVoteSellerDone.done"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showBuyerVoteSellerDone.click"/>&nbsp;<a href="showBuyerContact.do" class="data2Link"><bean:message key="showBuyerVoteSellerDone.here"/></a>&nbsp;<bean:message key="showBuyerVoteSellerDone.goToContacts"/>.
						</td>
					</tr>
				</table>
			</td>
