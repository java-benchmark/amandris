				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showBuyerPayDone.done"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data1Text" align="center">
							<bean:message key="showBuyerPayDone.text1"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showBuyerPayDone.click"/>&nbsp;<a href="showBuyerContact.do" class="data2Link"><bean:message key="showBuyerPayDone.here"/></a>&nbsp;<bean:message key="showBuyerPayDone.goToContact"/>.
						</td>
					</tr>
				</table>
			</td>
