		...
		<tr valign="top">
			...
			<td height="450">	
				<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
					<html:form action="setBuyerSendContactMessage.do">
						<tr>
							<td class="data1Text" align="center">
								<bean:message key="showBuyerSendContactMessage.text1"/>
							</td>
						</tr>
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
									<tr bgcolor="#C185AA" height="30">
										<td width="100%" class="data1Text" align="right">
											<html:submit styleClass="form"><bean:message key="showBuyerSendContactMessage.send"/></html:submit>&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
									</tr>
								</table>
							</td>
