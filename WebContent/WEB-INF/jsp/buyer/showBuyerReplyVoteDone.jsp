				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showBuyerReplyVoteDone.done"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showBuyerReplyVoteDone.click"/>&nbsp;<a href="showBuyerVote.do" class="data2Link"><bean:message key="showBuyerReplyVoteDone.here"/></a>&nbsp;<bean:message key="showBuyerReplyVoteDone.goToVote"/>.
						</td>
					</tr>
				</table>
			</td>
