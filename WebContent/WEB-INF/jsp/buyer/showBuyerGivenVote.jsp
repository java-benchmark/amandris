						  		...
						  		<tr>
						  			<td>
			  						  	<table width="704" cellpadding="0" cellspacing="0" border="0">
			  						  		<logic:empty name="buyerGivenVoteData" property="votes">
			  						  			<tr>
			  						  				<td class="data1Text" align="center">
			  						  					<bean:message key="showBuyerGivenVote.voteNotExist"/>
			  						  				</td>
			  						  			</tr>
			  						  			<tr>
				  						  			<td height="10"></td>
				  						  	...
				  						  	<logic:notEmpty name="buyerGivenVoteData" property="votes">
					  						  	<tr>
				  						  			<td></td>
			  						  				<td class="data1Text" align="center">
			  						  					<bean:message key="showBuyerGivenVote.text"/>
			  						  				</td>
			  						  				<td></td>
			  						  			</tr>
												<tr>
			  						  			...
			  						  			<tr>
							  						...
							  						<td>
							  						  	<table width="554" cellpadding="0" cellspacing="0" border="0" align="center">
													  		<tr align="center">
										  						<td class="data2Text">
											  						<bean:message key="showBuyerGivenVote.totalVotes"/>:&nbsp;<b><bean:write name="buyerGivenVoteData" property="totalVotes"/></b>&nbsp;&nbsp;&nbsp;
										  							<bean:message key="showBuyerGivenVote.positiveVotes"/>:&nbsp;<b><span style="color:#00AA00;"/><bean:write name="buyerGivenVoteData" property="positiveVotes"/></span></b>&nbsp;(<bean:write name="buyerGivenVoteData" property="positiveVotesPercentage"/>%)&nbsp;&nbsp;&nbsp;
										  							<bean:message key="showBuyerGivenVote.negativeVotes"/>:&nbsp;<span style="color:#AA0000;"/><b><bean:write name="buyerGivenVoteData" property="negativeVotes"/></b></span>&nbsp;&nbsp;&nbsp;
										  						</td>
													  		</tr>
													  	</table>
							  						</td>
												...
												<tr>
				  						  		...
				  						  		<logic:iterate name="buyerGivenVoteData" property="votes" id="collection">
											  		<tr>
														  				...
														  				<table cellpadding="0" cellspacing="0" border="0" align="left" valign="top">
														  					...
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
														  							<b><bean:message key="showBuyerGivenVote.date"/>:</b>&nbsp;
														  					...
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
															  						<logic:equal name="collection" property="vote" value="1">
															  							<img src="pictures/positiveVote.gif" alt="<bean:message key="showBuyerGivenVote.positiveVote"/>"/>
															  						</logic:equal>
															  						<logic:equal name="collection" property="vote" value="-1">
															  							<img src="pictures/negativeVote.gif" alt="<bean:message key="showBuyerGivenVote.negativeVote"/>"/>
															  						</logic:equal>
														  						</td>
														  					</tr>
														  				</table>
														  				...
														  				<table cellpadding="0" cellspacing="0" border="0">
														  					...
														  					<logic:notEmpty name="collection" property="reply">
														  						<logic:equal name="collection" property="replyActive" value="1">
																  					...
																  					<tr>
																  						<td class="data2Text" align="left">
																  							<b><bean:message key="showBuyerGivenVote.answer"/>:</b>&nbsp;
