				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showBuyerPaymentDone.done"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showBuyerPaymentDone.click"/>&nbsp;<a href="showBuyerStart.do" class="data2Link"><bean:message key="showBuyerPaymentDone.here"/></a>&nbsp;<bean:message key="showBuyerPaymentDone.goToStart"/>.
						</td>
					</tr>
				</table>
			</td>
