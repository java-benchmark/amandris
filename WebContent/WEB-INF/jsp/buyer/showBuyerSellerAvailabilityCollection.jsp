		  						  				...
		  						  				<logic:notEmpty name="sellerCollection">
				  						  			...
				  						  			<td>
								  			  			<amandris:pagerTag 	styleClass="pagerTextLink" 
																	name="pager" 
																	action ="showBuyerSellerAvailabilityCollection.do?foo" 
																	maxPages="7" 
														  			...
														  			<td width="9" align="center"><img src="pictures/verticalSeparator.gif"/></td>
																		<td valign="top" align="left">
														  				<table cellpadding="0" cellspacing="0" border="0" align="left">
														  					...
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
															  						<b><bean:message key="showBuyerSellerCollection.freeContact"/>:</b>
															  						<logic:equal name="collection" property="freeContacts" value="1">
															  							<bean:message key="common.yes"/>
															  						</logic:equal>
															  						<logic:equal name="collection" property="freeContacts" value="0">
															  							<bean:message key="common.no"/>
															  						</logic:equal>
														  						</td>
														  					</tr>
