...
<table border="0" cellpadding="0" cellspacing="0" align="left" valign="top">
	...
	<logic:empty name="adminEditSellerForm">
		<tr>
			<td class="data2text">
				No existe el ofertante
			</td>
		</tr>
	</logic:empty>

	<logic:notEmpty name="adminEditSellerForm">	
		<html:form action="setAdminSeller.do">
			<tr>
				<td width="20"></td>
				<td>
					<table border="0" cellpadding="0" cellspacing="5" align="left" valign="top">
						<tr>
							...
							<td class="data2text" valign="top">
								<bean:write name="adminEditSellerForm" property="id"/>
							</td>
						</tr>
						<tr>
							<td class="data2text" valign="top">
						...
						<tr>
							...
							<td class="data2text">
								<html:text styleClass="form" property="credits" size="3"/>
							</td>
						</tr>
					</table>
				</td>
