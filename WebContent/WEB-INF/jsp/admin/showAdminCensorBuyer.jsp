	...
	<tr>
		<td>
			<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
				...
				<logic:iterate name="adminCensorBuyerCollection" id="collection">
					<tr bgcolor="#E0E0E0">
						<td width="20"></td>
						<td class="data2text">
							<a href="showAdminCensorBuyerDetail.do?id=<bean:write name="collection" property="id"/>" class="data2Link">
