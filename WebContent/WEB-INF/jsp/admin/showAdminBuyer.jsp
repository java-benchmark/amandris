...
<table border="0" cellpadding="0" cellspacing="0" align="left" valign="top">
	...
	<logic:empty name="adminEditBuyerForm">
		<tr>
			<td class="data2text">
				No existe el demandante
			</td>
		</tr>
	</logic:empty>

	<logic:notEmpty name="adminEditBuyerForm">	
		<html:form action="setAdminBuyer.do">
			<tr>
				<td width="20"></td>
				<td>
					<table border="0" cellpadding="0" cellspacing="5" align="left" valign="top">
						<tr>
							...
							<td class="data2text" valign="top">
								<bean:write name="adminEditBuyerForm" property="id"/>
							</td>
						</tr>
						<tr>
							<td class="data2text" valign="top">
