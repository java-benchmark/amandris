						  		...
						  		<tr>
						  			<td>
			  						  	<table width="704" cellpadding="0" cellspacing="0" border="0">
			  						  		<logic:empty name="otherSellerVoteData" property="votes">
			  						  			<tr>
			  						  				<td class="data1Text" align="center">
			  						  					<bean:message key="showOtherSellerVote.voteNotExist"/>
			  						  				</td>
			  						  			</tr>
												<tr>
				  						  			<td height="10"></td>
												...
												<tr>
							  						<td align="left">
							  						  	<table cellpadding="0" cellspacing="0" border="0" align="left">
													  		<tr align="center">
										  						<td class="data2Text">
										  							<a href="showOtherSellerVote.do?id=<bean:write name="otherSellerVoteData" property="id"/>">
												  						<html:img bundle="IMAGE_RESOURCE_KEY" srcKey="sellerReceivedVotesActive" border="0"/>
												  					</a>
										  						</td>
										  						<td width="10"></td>
										  						<td class="data2Text">
											  						<a href="showOtherSellerGivenVote.do?id=<bean:write name="otherSellerVoteData" property="id"/>">
				  						  	...
				  						  	<logic:notEmpty name="otherSellerVoteData" property="votes">
					  						  	<tr>
				  						  			<td></td>
			  						  				<td class="data1Text" align="center">
			  						  					<bean:message key="showOtherSellerVote.text"/>
			  						  				</td>
			  						  				<td></td>
			  						  			</tr>
												<tr>
			  						  			...
			  						  			<tr>
							  						...
							  						<td>
							  						  	<table width="554" cellpadding="0" cellspacing="0" border="0" align="center">
													  		<tr align="center">
										  						<td class="data2Text">
											  						<bean:message key="showOtherSellerVote.totalVotes"/>:&nbsp;<b><bean:write name="otherSellerVoteData" property="totalVotes"/></b>&nbsp;&nbsp;&nbsp;
										  							<bean:message key="showOtherSellerVote.positiveVotes"/>:&nbsp;<b><span style="color:#00AA00;"/><bean:write name="otherSellerVoteData" property="positiveVotes"/></span></b>&nbsp;(<bean:write name="otherSellerVoteData" property="positiveVotesPercentage"/>%)&nbsp;&nbsp;&nbsp;
										  							<bean:message key="showOtherSellerVote.negativeVotes"/>:&nbsp;<span style="color:#AA0000;"/><b><bean:write name="otherSellerVoteData" property="negativeVotes"/></b></span>&nbsp;&nbsp;&nbsp;
										  						</td>
													  		</tr>
													  	</table>
							  						</td>
												...
												<tr>
				  						  		...
				  						  		<logic:iterate name="otherSellerVoteData" property="votes" id="collection">
											  		<tr>
														  				...
														  				<table cellpadding="0" cellspacing="0" border="0" align="left" valign="top">
														  					...
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
														  							<b><bean:message key="showOtherSellerVote.date"/>:</b>&nbsp;
														  					...
														  					<tr align="left">
														  						<td nowrap class="data1Text" align="left">
															  						<logic:equal name="collection" property="vote" value="1">
															  							<img src="pictures/positiveVote.gif" alt="<bean:message key="showOtherSellerVote.positiveVote"/>"/>
															  						</logic:equal>
															  						<logic:equal name="collection" property="vote" value="-1">
															  							<img src="pictures/negativeVote.gif" alt="<bean:message key="showOtherSellerVote.negativeVote"/>"/>
															  						</logic:equal>
														  						</td>
														  					</tr>
														  				</table>
														  				...
														  				<table cellpadding="0" cellspacing="0" border="0">
														  					...
														  					<logic:notEmpty name="collection" property="reply">
														  						<logic:equal name="collection" property="replyActive" value="1">
																  					...
																  					<tr>
																  						<td class="data2Text" align="left">
																  							<b><bean:message key="showOtherSellerVote.answer"/>:</b>&nbsp;
