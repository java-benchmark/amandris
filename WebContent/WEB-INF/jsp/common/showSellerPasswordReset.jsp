					...
					<tr>
						<td align="center">
							<table cellspacing="10">
								<html:form action="setSellerPasswordResetSendEmail.do">
									<tr height="15"><td></td></tr>			
									<tr>
										<td class="data2Text" align="center">
											<bean:message key="showSellerPasswordReset.text1"/>
										</td>
									</tr>
									...
									<tr>
										<td class="data2Text" align="center">
											<bean:message key="showSellerPasswordReset.yourEmail"/>
											<html:text property="email" styleClass="form"/>
										</td>
									</tr>
									<tr>
										<td class="data2Text" align="center">
											<html:submit styleClass="form"><bean:message key="showSellerPasswordReset.send"/></html:submit>
										</td>
									</tr>
								</html:form>
							</table>
