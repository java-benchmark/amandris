				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
									...
									<logic:greaterEqual name="profilePictures" property="picturesCount" value="1">
										<td align="center" width="80" class="data1Text">
											<logic:notEqual name="profilePictures" property="bigPictureIndex" value="1">
												<a href="showBuyerProfilePictures.do?id=<bean:write name="profilePictures" property="userId"/>&picture=<bean:write name="profilePictures" property="picture1Index"/>" class="data1Link">
											</logic:notEqual>
									...
									<logic:greaterEqual name="profilePictures" property="picturesCount" value="2">
										<td align="center" width="80" class="data1Text">
											<logic:notEqual name="profilePictures" property="bigPictureIndex" value="2">
												<a href="showBuyerProfilePictures.do?id=<bean:write name="profilePictures" property="userId"/>&picture=<bean:write name="profilePictures" property="picture2Index"/>" class="data1Link">
											</logic:notEqual>
									...
									<logic:greaterEqual name="profilePictures" property="picturesCount" value="3">
										<td align="center" width="80" class="data1Text">
											<logic:notEqual name="profilePictures" property="bigPictureIndex" value="3">
												<a href="showBuyerProfilePictures.do?id=<bean:write name="profilePictures" property="userId"/>&picture=<bean:write name="profilePictures" property="picture3Index"/>" class="data1Link">
											</logic:notEqual>
									...
									<logic:greaterEqual name="profilePictures" property="picturesCount" value="4">
										<td align="center" width="80" class="data1Text">
											<logic:notEqual name="profilePictures" property="bigPictureIndex" value="4">
												<a href="showBuyerProfilePictures.do?id=<bean:write name="profilePictures" property="userId"/>&picture=<bean:write name="profilePictures" property="picture4Index"/>" class="data1Link">
											</logic:notEqual>
									...
									<logic:greaterEqual name="profilePictures" property="picturesCount" value="5">
										<td align="center" width="80" class="data1Text">
											<logic:notEqual name="profilePictures" property="bigPictureIndex" value="5">
												<a href="showBuyerProfilePictures.do?id=<bean:write name="profilePictures" property="userId"/>&picture=<bean:write name="profilePictures" property="picture5Index"/>" class="data1Link">
											</logic:notEqual>
					...
					<tr>
						<td height="40" align="center" valign="middle">
							<button class="form" onclick="document.location.href='showBuyer.do?id=<bean:write name="profilePictures" property="userId"/>'"><bean:message key="showBuyerProfilePictures.backToProfile"/></button>
						</td>
					</tr>
					<tr>
						<td align="center">
