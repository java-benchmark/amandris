				...
				<table width="90%" cellspadding="0" cellspacing="0" border="0">
					<tr>
						<td class="data3Text" align="center">
							<bean:message key="showPasswordResetDone.text1"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showPasswordResetDone.text2"/>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showPasswordResetDone.click"/>&nbsp;<a href="http://www.amandris.com" class="data2Link"><bean:message key="showPasswordResetDone.here"/></a>&nbsp;<bean:message key="showPasswordResetDone.goToIndex"/>.
						</td>
					</tr>
				</table>
			</td>
