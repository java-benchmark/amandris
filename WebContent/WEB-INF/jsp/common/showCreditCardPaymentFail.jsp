				...
				<table width="85%" cellpadding="0" cellspacing="5" border="0">
					...
					<tr>
						<td class="data3Text" align="center">
							<b><bean:message key="showCreditCardPaymentFail.text1"/></b>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showCreditCardPaymentFail.text2"/>
						</td>
					</tr>
					...
					<tr>
						<td class="data2Text" align="center">
							...
							<logic:present name="sellerSession">
								...
								<bean:message key="showCreditCardPaymentFail.gotoStart"/>
							</a>
						</td>
					</tr>
				</table>
