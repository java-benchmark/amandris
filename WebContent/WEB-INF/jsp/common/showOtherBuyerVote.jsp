						  		...
						  		<tr>
						  			<td>
			  						  	<table width="704" cellpadding="0" cellspacing="0" border="0">
			  						  		<logic:empty name="otherBuyerVoteData" property="votes">
			  						  			<tr>
			  						  				<td class="data1Text" align="center">
			  						  					<bean:message key="showOtherBuyerVote.voteNotExist"/>
			  						  				</td>
			  						  			</tr>
												<tr>
				  						  			<td height="10"></td>
												...
												<tr>
							  						<td align="left">
							  						  	<table cellpadding="0" cellspacing="0" border="0" align="left">
													  		<tr align="center">
										  						<td class="data2Text">
										  							<a href="showOtherBuyerVote.do?id=<bean:write name="otherBuyerVoteData" property="id"/>">
												  						<html:img bundle="IMAGE_RESOURCE_KEY" srcKey="buyerReceivedVotesActive" border="0"/>
												  					</a>
										  						</td>
										  						<td width="10"></td>
										  						<td class="data2Text">
											  						<a href="showOtherBuyerGivenVote.do?id=<bean:write name="otherBuyerVoteData" property="id"/>">
				  						  	...
				  						  	<logic:notEmpty name="otherBuyerVoteData" property="votes">
					  						  	<tr>
				  						  			<td></td>
			  						  				<td class="data1Text" align="center">
			  						  					<bean:message key="showOtherBuyerVote.text"/>
			  						  				</td>
			  						  				<td></td>
			  						  			</tr>
												<tr>
			  						  			...
			  						  			<tr>
							  						...
							  						<td>
							  						  	<table width="554" cellpadding="0" cellspacing="0" border="0" align="center">
													  		<tr align="center">
										  						<td class="data2Text">
											  						<bean:message key="showOtherSellerVote.totalVotes"/>:&nbsp;<b><bean:write name="otherBuyerVoteData" property="totalVotes"/></b>&nbsp;&nbsp;&nbsp;
										  							<bean:message key="showOtherSellerVote.positiveVotes"/>:&nbsp;<b><span style="color:#00AA00;"/><bean:write name="otherBuyerVoteData" property="positiveVotes"/></span></b>&nbsp;(<bean:write name="otherBuyerVoteData" property="positiveVotesPercentage"/>%)&nbsp;&nbsp;&nbsp;
										  							<bean:message key="showOtherSellerVote.negativeVotes"/>:&nbsp;<span style="color:#AA0000;"/><b><bean:write name="otherBuyerVoteData" property="negativeVotes"/></b></span>&nbsp;&nbsp;&nbsp;
										  						</td>
													  		</tr>
													  	</table>
							  						</td>
												...
												<tr>
				  						  		...
				  						  		<logic:iterate name="otherBuyerVoteData" property="votes" id="collection">
											  		<tr>
