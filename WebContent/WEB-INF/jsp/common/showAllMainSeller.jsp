			  			  	...
			  			  	<table width="704" cellpadding="0" cellspacing="0" border="0" valign="top">
			  			  		<tr>
			  			  			<td align="right">
			  			  				<table width="704" cellpadding="0" cellspacing="0" border="0" valign="top">
						  			  		<tr>
		  						  				<logic:notEmpty name="mainSellerCollection">
				  						  			...
				  						  			<td>
								  			  			<amandris:pagerTag 	styleClass="pagerTextLink" 
																	name="pager" 
																	action ="showAllMainSeller.do?foo" 
																	maxPages="7" 
						  		...
						  		<tr>
						  			<td>
			  						  	<table width="704" cellpadding="0" cellspacing="0" border="0">
			  						  		<logic:empty name="mainSellerCollection">
			  						  			<tr>
				  						  	...
				  						  	<logic:notEmpty name="mainSellerCollection">
				  						  		<logic:iterate name="mainSellerCollection" id="collection">
											  		<tr>
