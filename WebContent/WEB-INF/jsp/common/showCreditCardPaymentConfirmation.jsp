				...
				<table width="85%" cellpadding="0" cellspacing="5" border="0">
					...
					<tr>
						<td class="data3Text" align="center">
							<b><bean:message key="showCreditCardPaymentConfirmation.text1"/></b>
						</td>
					</tr>
					<tr><td height="20"></td></tr>
					<tr>
						<td class="data2Text" align="center">
							<bean:message key="showCreditCardPaymentConfirmation.text2"/>
						</td>
					</tr>
					...
					<tr>
						<td class="data2Text" align="center">
							<logic:present name="buyerSession">
								<a href="showBuyerStart.do" class="data3Link">
							</logic:present>
							<logic:present name="sellerSession">
								<a href="showSellerStart.do" class="data3Link">
							</logic:present>
								<bean:message key="showCreditCardPaymentConfirmation.gotoStart"/>
							</a>
						</td>
					</tr>
				</table>
