...
public class NewPasswordMailObject {

	private String login;
	private String password;
	private Locale locale;
	
	public NewPasswordMailObject( Locale theLocale)
	{
		login 	= "";
		password	= "";
		locale	= theLocale;
	...
	public String toString()
	{
		...
		result.append( ConfigurationParameterManager.getMessages().getMessage( locale, "newPasswordMailObject.text1"));
		result.append( "</td>");
		result.append( "</tr>");
		result.append( "<tr>");
		result.append( "<td align='center' style='font-family:arial; font-size:14;'>");
		result.append( ConfigurationParameterManager.getMessages().getMessage( locale, "newPasswordMailObject.text2"));
		result.append( "</td>");
		result.append( "</tr>");
		result.append( "<tr>");
		result.append( "<td align='center' style='font-family:arial; font-size:16;'>");
		result.append( ConfigurationParameterManager.getMessages().getMessage( locale, "newPasswordMailObject.text3", login));
		result.append( "</td>");
		result.append( "</tr>");
		result.append( "<tr>");
		result.append( "<td align='center' style='font-family:arial; font-size:16;'>");
		result.append( ConfigurationParameterManager.getMessages().getMessage( locale, "newPasswordMailObject.text4", password));
		result.append( "</td>");
		result.append( "</tr>");
		result.append( "<tr><td height='30'></td></tr>");
		result.append( "<tr>");
		result.append( "<td align='center' style='font-family:arial; font-size:9;'>");
		result.append( ConfigurationParameterManager.getMessages().getMessage( locale, "newPasswordMailObject.text5"));
		result.append( "</td>");
		result.append( "</tr>");
		result.append( "</table>");
		result.append( "</td>");
