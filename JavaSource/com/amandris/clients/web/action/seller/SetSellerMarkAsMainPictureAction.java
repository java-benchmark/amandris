...
public class SetSellerMarkAsMainPictureAction extends AbstractAction {
	...
	public ActionForward execute( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		if( ! sellerFacade.markAsMainPicture( DBUtils.parseInteger( request.getParameter( "index"), 0), sellerSession))
