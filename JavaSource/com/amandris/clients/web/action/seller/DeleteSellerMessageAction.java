...
public class DeleteSellerMessageAction extends AbstractAction {
	...
	public ActionForward execute( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		if( ! messageFacade.deleteSellerMessageById( DBUtils.parseInteger( request.getParameter( "id"), 0), sellerSession.getId()))
