...
public class ShowBuyerVoteAction extends AbstractAction {
	...
	public ActionForward execute( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		Locale					locale					= null;
		VoteDataView			buyerVoteDataView		= null;
		...
		buyerVoteDataView = voteFacade.getBuyerVoteDataByBuyerId( buyerSession.getId(), "date", false, Boolean.TRUE, 0, Integer.MAX_VALUE, locale);
		
		request.setAttribute( Constant.BUYER_VOTE_DATA_OBJECT_NAME, buyerVoteDataView);
