...
public class MarkBuyerMessageAsNewAction extends AbstractAction {
	...
	public ActionForward execute( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		if( ! messageFacade.markBuyerMessageAsNewById( DBUtils.parseInteger( request.getParameter( "id"), 0), buyerSession.getId()))
