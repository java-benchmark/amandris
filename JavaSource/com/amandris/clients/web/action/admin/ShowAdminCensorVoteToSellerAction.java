...
public class ShowAdminCensorVoteToSellerAction extends AbstractAction {
	...
	public ActionForward execute( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		Locale					locale					= null;
		Collection				voteToSellerCollection	= null;
		...
		voteToSellerCollection = voteFacade.getVoteToSellerToCensor( locale);
		
		session.setAttribute( Constant.ADMIN_CENSOR_VOTE_TO_SELLER_COLLECTION_OBJECT_NAME, voteToSellerCollection);
