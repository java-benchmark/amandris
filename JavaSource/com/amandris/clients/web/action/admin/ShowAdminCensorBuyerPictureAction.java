...
public class ShowAdminCensorBuyerPictureAction extends AbstractAction {
	...
	public ActionForward execute( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		Locale					locale					= null;
		Collection				buyerPictureCollection	= null;
		...
		buyerPictureCollection = buyerFacade.getBuyerToCensorPicture();
		
		session.setAttribute( Constant.ADMIN_CENSOR_BUYER_PICTURE_COLLECTION_OBJECT_NAME, buyerPictureCollection);
