...
public class BuyerSellerSearchForm extends ValidatorForm implements Serializable{
	...
	private Boolean service_companyWithoutSex;
	private Boolean service_companyWithSex;
	private Boolean service_sex;
	private Boolean service_eroticShow;
	private String  companyWithoutSexPriceHigh;
	private String  companyWithSexPriceHigh;
	private String  sexPriceHigh;
	private String  eroticShowPriceHigh;
	...
	private static final long serialVersionUID = 7526471155622776001L;
	
	public BuyerSellerSearchForm()
	{
		mySex 						= new Integer( 1);
		login 						= "";
		ageLow 						= "18";
		ageHigh 					= "99";
		service_companyWithoutSex 	= new Boolean( false);
		service_companyWithSex 		= new Boolean( false);
		service_sex 				= new Boolean( false);
		service_eroticShow 			= new Boolean( false);
		...
		saveSearch 					= new Boolean( false);
		itemsPerPage 				= "8";
		orderedBy 					= "";		
		isOnline 					= new Boolean( false);
		isFreeContact	 			= new Boolean( false);
		hasAlbum 					= new Boolean( false);
		saveSearchName 				= "";
		buyerId						= null;
	}
	...
	public void setMySex(Integer mySex) {
		this.mySex = mySex;
	}
	...
	public String getCompanyWithoutSexPriceHigh() {
		return companyWithoutSexPriceHigh;
	}


	public void setCompanyWithoutSexPriceHigh(String companyWithoutSexPriceHigh) {
		this.companyWithoutSexPriceHigh = companyWithoutSexPriceHigh;
	}


	public String getCompanyWithSexPriceHigh() {
		return companyWithSexPriceHigh;
	}


	public void setCompanyWithSexPriceHigh(String companyWithSexPriceHigh) {
		this.companyWithSexPriceHigh = companyWithSexPriceHigh;
	}


	public String getEroticShowPriceHigh() {
		return eroticShowPriceHigh;
	}


	public void setEroticShowPriceHigh(String eroticShowPriceHigh) {
		this.eroticShowPriceHigh = eroticShowPriceHigh;
	}


	public String getSexPriceHigh() {
		return sexPriceHigh;
	}


	public void setSexPriceHigh(String sexPriceHigh) {
		this.sexPriceHigh = sexPriceHigh;
	}


	public Boolean getService_companyWithoutSex() {
		return service_companyWithoutSex;
	}


	public void setService_companyWithoutSex(Boolean service_companyWithoutSex) {
		this.service_companyWithoutSex = service_companyWithoutSex;
	}


	public Boolean getService_companyWithSex() {
		return service_companyWithSex;
	}


	public void setService_companyWithSex(Boolean service_companyWithSex) {
		this.service_companyWithSex = service_companyWithSex;
	}


	public Boolean getService_eroticShow() {
		return service_eroticShow;
	}


	public void setService_eroticShow(Boolean service_eroticShow) {
		this.service_eroticShow = service_eroticShow;
	}


	public Boolean getService_sex() {
		return service_sex;
	}


	public void setService_sex(Boolean service_sex) {
	...
	public String toString() {
		...
		string = string + "mySex=" + mySex + "\n" + "\n";
		string = string + "ageLow=" + ageLow + "\n";
		string = string + "ageHigh=" + ageHigh + "\n";
		string = string + "login=" + login + "\n";
		string = string + "sex_girl=" + sex_girl + "\n";
		string = string + "sex_boy=" + sex_boy + "\n";
		string = string + "sex_shemale=" + sex_shemale + "\n";
		string = string + "sex_boysCouple=" + sex_boysCouple + "\n";
		string = string + "sex_girlsCouple=" + sex_girlsCouple + "\n";
		string = string + "sex_boyAndGirlCouple=" + sex_boyAndGirlCouple + "\n";
		string = string + "sex_group=" + sex_group + "\n";
		string = string + "state=" + state + "\n";
		string = string + "country=" + country + "\n";
		string = string + "service_companyWithoutSex=" + service_companyWithoutSex + "\n";
		string = string + "service_companyWithSex=" + service_companyWithSex + "\n";
		string = string + "service_sex=" + service_sex + "\n";
		string = string + "service_eroticShow=" + service_eroticShow + "\n";
		string = string + "companyWithoutSexPriceHigh=" + companyWithoutSexPriceHigh + "\n";
		string = string + "companyWithSexPriceHigh=" + companyWithSexPriceHigh + "\n";
		string = string + "sexPriceHigh=" + sexPriceHigh + "\n";
		string = string + "eroticShowPriceHigh=" + eroticShowPriceHigh + "\n";
		string = string + "origin_caucasic=" + origin_caucasic + "\n";
		string = string + "origin_indian=" + origin_indian + "\n";
		string = string + "origin_oriental=" + origin_oriental + "\n";
		string = string + "origin_african=" + origin_african + "\n";
		string = string + "origin_arabian=" + origin_arabian + "\n";
		string = string + "origin_hispanic=" + origin_hispanic + "\n";
		string = string + "origin_mediterranean=" + origin_mediterranean + "\n";
		string = string + "skinColor_white=" + skinColor_white + "\n";
		string = string + "skinColor_dark=" + skinColor_dark + "\n";
		string = string + "skinColor_veryDark=" + skinColor_veryDark + "\n";
		string = string + "skinColor_black=" + skinColor_black + "\n";
		string = string + "hairColor_white=" + hairColor_white + "\n";
		string = string + "hairColor_blonde=" + hairColor_blonde + "\n";
		string = string + "hairColor_brown=" + hairColor_brown + "\n";
		string = string + "hairColor_red=" + hairColor_red + "\n";
		string = string + "hairColor_dark=" + hairColor_dark + "\n";
		string = string + "hairLength_noHair=" + hairLength_noHair + "\n";
		string = string + "hairLength_short=" + hairLength_short + "\n";
		string = string + "hairLength_untilNeck=" + hairLength_untilNeck + "\n";
		string = string + "hairLength_untilShoulders=" + hairLength_untilShoulders + "\n";
		string = string + "hairLength_beyondShoulders=" + hairLength_beyondShoulders + "\n";
		string = string + "eyeColor_green=" + eyeColor_green + "\n";
		string = string + "eyeColor_blue=" + eyeColor_blue + "\n";
		string = string + "eyeColor_brown=" + eyeColor_brown + "\n";
		string = string + "eyeColor_black=" + eyeColor_black + "\n";
		string = string + "language_spanish=" + language_spanish + "\n";
		string = string + "language_english=" + language_english + "\n";
		string = string + "language_portuguese=" + language_portuguese + "\n";
		string = string + "language_french=" + language_french + "\n";
		string = string + "language_german=" + language_german + "\n";
		string = string + "language_italian=" + language_italian + "\n";
		string = string + "language_japanesse=" + language_japanesse + "\n";
		string = string + "language_chinesse=" + language_chinesse + "\n";
		string = string + "language_arabian=" + language_arabian + "\n";
		string = string + "educationLevel_primary=" + educationLevel_primary + "\n";
		string = string + "educationLevel_seconday=" + educationLevel_seconday + "\n";
		string = string + "educationLevel_universitary=" + educationLevel_universitary + "\n";
		string = string + "educationLevel_postDegree=" + educationLevel_postDegree + "\n";
		string = string + "smoker_noSmoker=" + smoker_noSmoker + "\n";
		string = string + "smoker_eventuallySmoker=" + smoker_eventuallySmoker + "\n";
		string = string + "smoker_smoker=" + smoker_smoker + "\n";
		string = string + "physique_thin=" + physique_thin + "\n";
		string = string + "physique_normal=" + physique_normal + "\n";
		string = string + "physique_fat=" + physique_fat + "\n";
		string = string + "physique_muscled=" + physique_muscled + "\n";
		string = string + "physique_atlethic=" + physique_atlethic + "\n";
		string = string + "height_lessThan150=" + height_lessThan150 + "\n";
		string = string + "height_between150And159=" + height_between150And159 + "\n";
		string = string + "height_between160And169=" + height_between160And169 + "\n";
		string = string + "height_between170And179=" + height_between170And179 + "\n";
		string = string + "height_between180And1890" + height_between180And189 + "\n";
		string = string + "height_between190And200=" + height_between190And200 + "\n";
		string = string + "height_moreThan200=" + height_moreThan200 + "\n";
		string = string + "orientation_heterosexual=" + orientation_heterosexual + "\n";
		string = string + "orientation_homosexual=" + orientation_homosexual + "\n";
		string = string + "orientation_bisexual=" + orientation_bisexual + "\n";
		string = string + "orientation_bicurious=" + orientation_bicurious + "\n";
		string = string + "pennisSize_normal=" + pennisSize_normal + "\n";
		string = string + "pennisSize_biggerThanNormal=" + pennisSize_biggerThanNormal + "\n";
		string = string + "pennisSize_big=" + pennisSize_big + "\n";
		string = string + "pennisSize_veryBig=" + pennisSize_veryBig + "\n";
		string = string + "breastSize_small=" + breastSize_small + "\n";
		string = string + "breastSize_normal=" + breastSize_normal + "\n";
		string = string + "breastSize_big=" + breastSize_big + "\n";
		string = string + "breastSize_veryBig0" + breastSize_veryBig + "\n";
		string = string + "saveSearch=" + saveSearch + "\n";
		string = string + "saveSearchName=" + saveSearchName + "\n";
		string = string + "itemsPerPage=" + itemsPerPage + "\n";
		string = string + "orderedBy=" + orderedBy + "\n";
		string = string + "isOnline=" + isOnline + "\n";
		string = string + "isFreeContact=" + isFreeContact + "\n";
		string = string + "hasAlbum=" + hasAlbum + "\n";
		string = string + "buyerId=" + buyerId + "\n";
