...
public class NewBuyerForm extends ValidatorForm implements Serializable{
	...
	private static final long serialVersionUID = 6543210125373276263L;
	
	public NewBuyerForm()
	{
		sendBulletin 	= Boolean.TRUE;
	...
	public Boolean getSendBulletin() {
		return sendBulletin;
	}

	public void setSendBulletin(Boolean sendBulletin) {
		this.sendBulletin = sendBulletin;
	}
